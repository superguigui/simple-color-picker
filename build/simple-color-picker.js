...
},{"./lib/properties":10,"prefix":11,"trim":12}],9:[function(require,module,exports){
'use strict';
...
},{"./compose":9,"trim":12}],11:[function(require,module,exports){
...
},{"lodash._baseflatten":15,"lodash._createwrapper":18,"lodash.functions":22,"lodash.restparam":28}],15:[function(require,module,exports){
/**
...
},{"lodash.isarguments":16,"lodash.isarray":17}],16:[function(require,module,exports){
/**
...
},{"lodash._arraycopy":19,"lodash._basecreate":20,"lodash._replaceholders":21}],19:[function(require,module,exports){
/**
...
},{"lodash._basefunctions":23,"lodash.keysin":25}],23:[function(require,module,exports){
/**
 * lodash 3.0.0 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash.isfunction":24}],24:[function(require,module,exports){
(function (global){
/**
 * lodash 3.0.3 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
...
},{"browserify-css":1}],30:[function(require,module,exports){
'use strict';
...
function SimpleColorPicker(options) {
  ...
  bindAll(this, 'onSaturationMouseMove', 'onSaturationMouseDown', 'onSaturationMouseUp', 'onHueMouseDown', 'onHueMouseUp', 'onHueMouseMove');
  ...
  this.$saturation.addEventListener('mousedown', this.onSaturationMouseDown);
  this.$hue.addEventListener('mousedown', this.onHueMouseDown);
...
SimpleColorPicker.prototype.setColor = function(color) {
  ...
  this.hueColor = this.color.clone().saturation(100).lightness(50);
  if(this.color.red() === this.color.green() && this.color.red() == this.color.blue()) {
    this.hueColor.red(255);
  }
  this.moveSelectorTo((this.color.saturationv() / 100) * (this.$saturation.offsetWidth - 5) + 5, (1 - (this.color.value() / 100)) * (this.$saturation.offsetHeight - 2) + 5);
  this.moveHueTo((1 - (this.hueColor.hue() / 360)) * (this.$hue.offsetHeight - 2) + 4);
};

SimpleColorPicker.prototype.remove = function() {
  this.$saturation.removeEventListener('mousedown', this.onSaturationMouseDown);
  this.$hue.removeEventListener('mousedown', this.onHueMouseDown);
  this.onSaturationMouseUp();
  this.onHueMouseUp();
...
SimpleColorPicker.prototype.moveSelectorTo = function(x, y) {
...
SimpleColorPicker.prototype.moveHueTo = function(y) {
...
SimpleColorPicker.prototype.updateHue = function() {
  this.$saturation.style.background = 'linear-gradient(to right, #fff 0%, ' + this.hueColor.hexString() + ' 100%)';
  this.updateColor();
};

SimpleColorPicker.prototype.updateColor = function() {
...
/* ============================================================================= 
  Events
============================================================================= */
SimpleColorPicker.prototype.onSaturationMouseDown = function(e) {
  var saturationOffset = offset(this.$saturation);
  this.moveSelectorTo(e.clientX - saturationOffset.left, e.clientY - saturationOffset.top);
  window.addEventListener('mouseup', this.onSaturationMouseUp);
  window.addEventListener('mousemove', this.onSaturationMouseMove);
  e.preventDefault();
};

SimpleColorPicker.prototype.onSaturationMouseMove = function(e) {
  var saturationOffset = offset(this.$saturation);
  this.moveSelectorTo(e.clientX - saturationOffset.left, e.clientY - saturationOffset.top);
};

SimpleColorPicker.prototype.onSaturationMouseUp = function(e) {
...
SimpleColorPicker.prototype.onHueMouseDown = function(e) {
  var hueOffset = offset(this.$hue);
  this.moveHueTo(e.clientY - hueOffset.top);
  window.addEventListener('mouseup', this.onHueMouseUp);
  window.addEventListener('mousemove', this.onHueMouseMove);
  e.preventDefault();
};

SimpleColorPicker.prototype.onHueMouseMove = function(e) {
  var hueOffset = offset(this.$hue);
  this.moveHueTo(e.clientY - hueOffset.top);
};

SimpleColorPicker.prototype.onHueMouseUp = function(e) {
...
},{"./css/style.css":29,"./utils/dom/offset":31,"./utils/maths/clamp":32,"color":2,"component-emitter":7,"dom-transform":8,"is-number":13,"lodash.bindall":14}],31:[function(require,module,exports){
